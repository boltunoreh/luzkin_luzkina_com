...
function wp_cumulus_createflashcode( $widget=false, $atts=NULL ){
	...
	if( $options['compmode']!='true' ){
		...
		$flashtag .= '</p><p>Полезные "<a href="http://www.wordpressplugins.ru/">плагины WordPress</a>" вы можете найти на сайте WordPressPlugins.ru. WP-Cumulus требует для просмотра <noindex><a href="http://www.adobe.com/go/getflashplayer" target="_blank" rel="nofollow">Flash Player 9</a></noindex> или выше.</p></div>';
		...
		$flashtag .= '<p>Различные "<a href="http://www.wordpressplugins.ru/">плагины WordPress</a>" вы можете найти на сайте WordPressPlugins.ru. WP-Cumulus требует для просмотра <noindex><a href="http://www.adobe.com/go/getflashplayer" target="_blank" rel="nofollow">Flash Player 9</a></noindex> или выше.</p>';
		$flashtag .= '</object>';
	}
	return $flashtag;
}
